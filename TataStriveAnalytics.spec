...
hiddenimports = ['typing_extensions', 'ultralytics', 'ultralytics.models', 'ultralytics.nn', 'ultralytics.utils', 'onnx', 'omegaconf', 'boxmot', 'lap', 'loguru', 'pkg_resources', 'setuptools', 'gdown', 'insightface', 'onnxruntime', 'scipy.spatial.distance', 'cv2', 'torch', 'torchvision', 'numpy', 'PIL', 'groq', 'dotenv', 'PyQt6', 'PyQt6.QtWidgets', 'PyQt6.QtCore', 'PyQt6.QtGui']
datas += collect_data_files('boxmot')
datas += collect_data_files('insightface')
hiddenimports += collect_submodules('boxmot')
